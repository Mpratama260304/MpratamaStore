  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        common: "border-slate-500/30 bg-slate-500/20 text-slate-300",
        rare: "border-blue-500/30 bg-blue-500/20 text-blue-300",
        epic: "border-purple-500/30 bg-purple-500/20 text-purple-300",
